...
<div class="animated fadeIn">
    ...
    <div class="row">
        ...
        <form action="{{ route('admin.course.edit',['id'=> $CourseEdits->id ]) }}" method="post" style="width:100%;">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $CourseEdits->title }}" class="form-control drop-radius" placeholder="ระบุชื่อคอร์ส" name="title">
         ...
         {{ $CourseEdits->content }}
                ...
                <div class="form-group row">
                        <div class="col-md-9">
                                ...
                                @component('dashboard.learning.course.section.curriculumedit',[
                       ...
                       @endcomponent
                        ...
                        <div class="col-md-3" style="text-align:right;">
                            ...
                            <div>
                            <input type="text" id="ckfinder-input-1" name="image_course" value="{{$CourseEdits->image_course}}" hidden >
    
                              @if($CourseEdits->image_course != "")
                            ...
                            <div class="d-image" style="text-align:center;{{$display}}">
                                ...
                                <img class="blah" src="{{$CourseEdits->image_course}}"   id="ckfinder-popup-1" style="width:100%;height:200px;">
                            </a>
                            <a href="#X" style="color:red;text-align:center;" class="remove-image">remove</a>
                        </div>
                    <input type="button" class="btn btn-default btn-upload-image" id="ckfinder-popup-2" value="Upload Image" style="width:100%;{{$displayBtnUpImg}}">
    ...
    <div class="form-group" style="margin-top:15px;">
            <button type="submit" class="btn btn-success drop-radius pull-right">อัพเดต</button>
