...
<div class="animated fadeIn">
    ...
    <div class="row">
        ...
        <form action="{{ route('admin.lessons.edit',['id'=> $Lessons->id ]) }}" method="post"  style="width:100%;">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $Lessons->title }}" class="form-control drop-radius" placeholder="ระบุชื่อคอร์ส" name="title">
